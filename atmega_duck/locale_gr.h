...
// Modifier(s), Key
const uint8_t ascii_gr[] PROGMEM = {
...
const uint8_t combinations_gr[] PROGMEM = {
...
static hid_locale_t locale_gr {
    (uint8_t*)ascii_gr, 128,
    (uint8_t*)utf8_gr, sizeof(utf8_gr) / 6,
    (uint8_t*)combinations_gr, sizeof(combinations_gr) / 8,
};