...
// Modifier(s), Key
const uint8_t ascii_no[] PROGMEM = {
...
const uint8_t combinations_no[] PROGMEM = {
...
static hid_locale_t locale_no {
    (uint8_t*)ascii_no, 128,
    (uint8_t*)utf8_no, sizeof(utf8_no) / 6,
    (uint8_t*)combinations_no, sizeof(combinations_no) / 8,
};