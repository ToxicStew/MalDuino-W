...
// Modifier(s), Key
const uint8_t ascii_fi[] PROGMEM = {
...
const uint8_t combinations_fi[] PROGMEM = {
...
static hid_locale_t locale_fi {
    (uint8_t*)ascii_fi, 128,
    (uint8_t*)utf8_fi, sizeof(utf8_fi) / 6,
    (uint8_t*)combinations_fi, sizeof(combinations_fi) / 8,
};