...
// Modifier(s), Key
const uint8_t ascii_se[] PROGMEM = {
...
const uint8_t combinations_se[] PROGMEM = {
...
static hid_locale_t locale_se {
    (uint8_t*)ascii_se, 128,
    (uint8_t*)utf8_se, sizeof(utf8_se) / 6,
    (uint8_t*)combinations_se, sizeof(combinations_se) / 8,
};