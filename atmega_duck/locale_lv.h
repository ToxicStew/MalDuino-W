...
// Modifier(s), Key
const uint8_t ascii_lv[] PROGMEM = {
...
const uint8_t combinations_lv[] PROGMEM = {
...
static hid_locale_t locale_lv {
    (uint8_t*)ascii_lv, 128,
    (uint8_t*)utf8_lv, sizeof(utf8_lv) / 6,
    (uint8_t*)combinations_lv, sizeof(combinations_lv) / 8,
};