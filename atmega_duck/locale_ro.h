...
// Modifier(s), Key
const uint8_t ascii_ro[] PROGMEM = {
...
const uint8_t combinations_ro[] PROGMEM = {
...
static hid_locale_t locale_ro {
    (uint8_t*)ascii_ro, 128,
    (uint8_t*)utf8_ro, sizeof(utf8_ro) / 6,
    (uint8_t*)combinations_ro, sizeof(combinations_ro) / 8,
};