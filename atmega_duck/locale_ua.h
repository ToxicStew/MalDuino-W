...
// Modifier(s), Key
const uint8_t ascii_ua[] PROGMEM = {
...
const uint8_t combinations_ua[] PROGMEM = {
};

static hid_locale_t locale_ua {
    (uint8_t*)ascii_ua, 128,
    (uint8_t*)utf8_ua, sizeof(utf8_ua) / 6,
    (uint8_t*)combinations_ua, sizeof(combinations_ua) / 8,
};