...
// Modifier(s), Key
const uint8_t ascii_is[] PROGMEM = {
...
const uint8_t combinations_is[] PROGMEM = {
...
static hid_locale_t locale_is {
    (uint8_t*)ascii_is, 128,
    (uint8_t*)utf8_is, sizeof(utf8_is) / 6,
    (uint8_t*)combinations_is, sizeof(combinations_is) / 8,
};