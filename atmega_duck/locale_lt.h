...
// Modifier(s), Key
const uint8_t ascii_lt[] PROGMEM = {
...
const uint8_t combinations_lt[] PROGMEM = {
};

static hid_locale_t locale_lt {
    (uint8_t*)ascii_lt, 128,
    (uint8_t*)utf8_lt, sizeof(utf8_lt) / 6,
    (uint8_t*)combinations_lt, sizeof(combinations_lt) / 8,
};