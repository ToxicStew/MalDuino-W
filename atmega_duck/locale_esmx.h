...
// Modifier(s), Key
const uint8_t ascii_esmx[] PROGMEM = {
...
const uint8_t utf8_esmx[] PROGMEM = {
...
const uint8_t combinations_esmx[] PROGMEM = {
...
static hid_locale_t locale_esmx {
    (uint8_t*)ascii_esmx, 128,
    (uint8_t*)utf8_esmx, sizeof(utf8_esmx) / 6,
    (uint8_t*)combinations_esmx, sizeof(combinations_esmx) / 8,
};