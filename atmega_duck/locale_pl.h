...
// Modifier(s), Key
const uint8_t ascii_pl[] PROGMEM = {
...
const uint8_t combinations_pl[] PROGMEM = {
    0x7E, 0x00, 0x00, 0x00, KEY_MOD_LSHIFT,         KEY_GRAVE,          KEY_NONE,           KEY_SPACE,          // ~
};

static hid_locale_t locale_pl {
    (uint8_t*)ascii_pl, 128,
    (uint8_t*)utf8_pl, sizeof(utf8_pl) / 6,
    (uint8_t*)combinations_pl, sizeof(combinations_pl) / 8,
};