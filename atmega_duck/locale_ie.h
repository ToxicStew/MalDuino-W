...
// Modifier(s), Key
const uint8_t ascii_ie[] PROGMEM = {
...
const uint8_t combinations_ie[] PROGMEM = {
...
static hid_locale_t locale_ie {
    (uint8_t*)ascii_ie, 128,
    (uint8_t*)utf8_ie, sizeof(utf8_ie) / 6,
    (uint8_t*)combinations_ie, sizeof(combinations_ie) / 8,
};